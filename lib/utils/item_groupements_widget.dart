...
class ItemGroupementWidget extends StatefulWidget {
  final GroupementModel groupement;
  bool showBoard = false;
  Function onTap;
  Function onDelete;

  ItemGroupementWidget({this.groupement, this.showBoard, this.onTap, this.onDelete});
...
class _ItemDoctorWidgetState extends State<ItemGroupementWidget> {
  bool showBoard = false;
          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                ...
                SvgPicture.asset(R.image.ic_drugs_child),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                    child: Text(
                                      S.of(context).lbl_total_members(
                                          widget.groupement.members == null ? '0' : widget.groupement.members.length.toString()),
                                      style: TextStyle(
                                ...
                                InkWell(
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Text(
                                        S.of(context).lbl_groupement_status(
                                            widget.groupement.groupement_flag == 1 ? 'Actif' : 'Inactif'),
                                        style: TextStyle(
                                            color: R.color.gray, fontSize: 14),
                                      )
                                    ],
...
Widget AlertDialogDelete(
    {BuildContext context, GroupementModel doctor, Function onDone}) =>
    AlertDialog(
