...
class ItemBeneficiaryWidget extends StatefulWidget {
  final BeneficiaryModel beneficiary;
  bool showBoard = false;
  Function onTap;
  Function onDelete;

  ItemBeneficiaryWidget({this.beneficiary, this.showBoard, this.onTap, this.onDelete});
...
class _ItemDoctorWidgetState extends State<ItemBeneficiaryWidget> {
  bool showBoard = false;
      ...
      child: Container(
        child: Row(
          children: <Widget>[
            Stack(
              children: <Widget>[
                CustomCircleAvatar(child: (widget.beneficiary.photo == null)? Image.asset(R.image.avatar) : new Image.memory(base64Decode(widget.beneficiary.photo.substring(23))) ),//Image.asset(R.image.avatar))
...
Widget AlertDialogDelete(
        {BuildContext context, BeneficiaryModel doctor, Function onDone}) =>
    AlertDialog(
