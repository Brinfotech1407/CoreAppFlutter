...
class FindGroupementPage extends StatefulWidget {
  @override
  _FindGroupementPageState createState() {
    return _FindGroupementPageState();
  }
}

class _FindGroupementPageState extends State<FindGroupementPage>
    with AutomaticKeepAliveClientMixin<FindGroupementPage> {
  @override
  void initState() {
    super.initState();
  }
